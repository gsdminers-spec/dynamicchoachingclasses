export const courses = [
  {
    ...
    features: ["Daily Practice Papers", "Weekly Mock Tests", "One-on-One Mentorship"],
    duration: "1 Year",
  },
  {
    ...
    features: ["NCERT Coverage", "Concept Building", "Regular Assessments"],
    duration: "2 Years",
  },
  {
    ...
    features: ["Advanced Problem Solving", "Time Management Drills", "Mock Test Series"],
    duration: "2 Years",
  },
  {
    id: "foundation-8-10",
    ...
    features: ["Mental Ability", "Olympiad Level Prep", "Subject Foundation"],
    duration: "3 Years",
  },
  {
    id: "crash-course",
    ...
    features: ["High-Weightage Topics", "Past Year Papers", "Doubt Clearing"],
    duration: "3-6 Months",
  }
];
...
export const notices = [
  { id: 1, date: "2024-04-10", title: "New Target Batch Starts", description: "Admissions open for the fresh NEET Target batch starting next Monday." },
  { id: 2, date: "2024-04-05", title: "Mega Mock Test", description: "All India level mock test scheduled for this Sunday. Mandatory for all students." },
  { id: 3, date: "2024-03-28", title: "Parent-Teacher Meeting", description: "A review session will be held online this weekend to discuss student progress." },
];
